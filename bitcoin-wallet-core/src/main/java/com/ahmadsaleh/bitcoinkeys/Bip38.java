...
public class Bip38 {
    ...
    public static String encryptNoEC(byte[] passphrase, String encodedPrivateKey, boolean isCompressed)
            throws GeneralSecurityException, UnsupportedEncodingException, AddressFormatException {

        DumpedPrivateKey dk = new DumpedPrivateKey(MAIN_NET_PARAMS, encodedPrivateKey);
